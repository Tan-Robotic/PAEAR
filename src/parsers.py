...
parser.add_argument('--tau', type=float, default=0.005, help='软更新系数0.005')
parser.add_argument('--buffer_size', type=int, default=1000, help='经验池容量1000')
parser.add_argument('--min_size', type=int, default=200, help='经验池超过200再训练')
parser.add_argument('--batch_size', type=int, default=100, help='每次训练64组样本')
